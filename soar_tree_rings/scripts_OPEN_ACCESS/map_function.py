...
def map2(x,y, title1):
    ...
    plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/from_GLODAP_check_Nov29_2024/checking_results3/{title1}.png', dpi=300, bbox_inches="tight")
    plt.close()
