...
new_sites = df_total.loc[(df_total['Comment'] == 'TW3516') | (df_total['Comment'] == 'TW3519')]
...
for i in range(0, len(sites)):
    ...
    plt.savefig(
        f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/Tree_Ring_Second_Check/{sites[i]}_errorbar_TRE2.png',
