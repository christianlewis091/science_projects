...
for i in range(0, len(cruises)):
    ...
    z, a = map(lons,  lats)
    map.scatter(z, a, marker=symbol[i], s = size1, color=colors[i], edgecolor='black', label=f'{cruises[i]}')

plt.legend(loc='lower left')
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/UCI_13C/output/Version3/sampling_map.png', dpi=300, bbox_inches="tight")
plt.close()
