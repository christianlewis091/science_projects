...
output_xvals = pd.DataFrame({'x': output_xvals}).sort_values(by=['x'], ascending=True)
...
# #
# reference_dictionary = pd.DataFrame({"Ref 2.S Means": ref2_mean_smooth,
...
# print(output_xvals_sorted)
# reference_dictionary['Decimal_date'] = output_xvals_sorted
