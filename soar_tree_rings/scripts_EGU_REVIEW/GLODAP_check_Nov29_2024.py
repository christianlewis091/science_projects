"""
Dec 4 2024 rerunning into EGU submission file for confirmation
...
reference.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/GLODAP_smoothed_fronts_sample_lons.xlsx')
print(len(reference))
...
df.to_excel(r'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/GLODAP_cbl_zones.xlsx')
...
df.to_excel(r'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/GLODAP_cbl_zones_sectors_assigned.xlsx')
print(len(df))
...
for b in range(0, len(basins)):
    ...
    for g in range(0, len(zones)):
        ...
        # plt.show()
        plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/GLODAP/{zones[g]}_{basins[b]}.png', dpi=300, bbox_inches="tight")
...
results.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/GLODAP_RESULTS_FINAL_DEC2_24.xlsx')
...
# Display the plots
plt.tight_layout()
plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/GLODAP/FIGURE_FINAL_DEC2.png', dpi=300, bbox_inches="tight")
