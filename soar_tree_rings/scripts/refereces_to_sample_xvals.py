...
reference3_smooth = monte_carlo_randomization_smooth(ref3['Decimal_date'], output_xvals['x'], ref3['D14C'], ref3['weightedstderr_D14C'], cutoff, n)
reference3_trend = monte_carlo_randomization_trend(ref3['Decimal_date'], output_xvals['x'], ref3['D14C'], ref3['weightedstderr_D14C'], cutoff, n)
