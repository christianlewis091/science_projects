...
for q in range(0, len(locations)):
    ...
    # Show the plot
    plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/HYSPLIT_check_Dec3_2024/HEATMAPS/{locations[q]}.png',
...
for front in fronts:
    ...
    plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/HYSPLIT_check_Dec3_2024/ORSI_SMOOTHED_TO_Xs/{front}.png', dpi=300, bbox_inches="tight")
    plt.close()
...
for g in range(0, len(zones)):
    ...
    plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/HYSPLIT_check_Dec3_2024/ZONE_ASSIGNMENT_CHECK/{zones[g]}_parsecheck.png', dpi=300, bbox_inches="tight")
    plt.close()
...
# output1.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/HYSPLIT_check_Dec3_2024/FINAL_OUTPUT_AND_GRAPHS/time_per_zone_usingpoints.xlsx')
...
for h in range(0, len(blah)):
    ...
    if h == 1:
        ax.legend()
    # Show the plot
    plt.savefig(f"C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/HYSPLIT_check_Dec3_2024/FINAL_OUTPUT_AND_GRAPHS/stackedbar_{blah[h]}.png", dpi=300, bbox_inches="tight")
