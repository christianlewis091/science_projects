...
time_dependent_results = pd.DataFrame({"Time": time_array, "Lat 1": lat1_array, "Lat 2": lat2_array, "P-value": p_array, "Time Min Year": time_array_minyear}).dropna(subset="P-value")
...
time_dependent_results_nz.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output/time_dependent_pvalues_nz.xlsx')
time_dependent_results_ch.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output/time_dependent_pvalues_ch.xlsx')

# fig = plt.figure()
# ax = plt.axes(projection='3d')
# ax.scatter(time_dependent_results_nz['Time Min Year'], time_dependent_results_nz['Lat 1'], time_dependent_results_nz['Lat 2'], c=time_dependent_results_nz['P-value'], cmap='viridis', linewidth=0.5)
# ax.set_xlabel('Date')
# ax.set_ylabel('Lat 1')
# ax.set_zlabel('Lat 2');
