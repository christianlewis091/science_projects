...
from heidelberg_intercomparison import monte_it1, monte_it2, monte_it3, monte_it4, monte_it5, my_x_1986_1991_arr
...
plt.plot(my_x_1986_1991_arr, monte_it1, color=colors[0])
...
plt.ylabel('\u0394$^1$$^4$CO$_2$ (\u2030)', fontsize=14)  # label the y axis
plt.savefig('C:/Users/lewis/venv/python310/python-masterclass-remaster-shared/'
            'radiocarbon_intercomparison/plots/cleanedFigs_monte_explain5.png',
            dpi=300, bbox_inches="tight")
plt.legend()
