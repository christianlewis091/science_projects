...
#
#     # Show the plot
#     plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/HYSPLIT/Heatmaps/{locations[q]}.png',
...
for front in fronts:
    ...
    plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/HYSPLIT/Orsi_smoothed/{front}.png', dpi=300, bbox_inches="tight")
    plt.close()

# here is the dataframe of the smoothed fronts, on the sampled longitudes
reference.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/smoothed_fronts_sample_lons.xlsx')
...
points.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/points_assigned.xlsx')
...
for g in range(0, len(zones)):
    ...
    plt.savefig(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/HYSPLIT/Zone_assignment/{zones[g]}_parsecheck.png', dpi=300, bbox_inches="tight")
    plt.close()
...
output1.to_excel('C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Data_Files/hysplit_time_per_zone_usingpoints.xlsx')
...
for h in range(0, len(blah)):
    ...
    if h == 1:
        ax.legend()
    # Show the plot
    plt.savefig(f"C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/HYSPLIT/stackedbar_{blah[h]}.png", dpi=300, bbox_inches="tight")
