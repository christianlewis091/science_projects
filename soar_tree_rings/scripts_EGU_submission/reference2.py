...
harmonized.to_excel('C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Data_Files/harmonized_dataset.xlsx')
...
plt.savefig('C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Images_and_Figures/reference2/Harmonized_dataset.png', dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('\u0394$^1$$^4$CO$_2$ (\u2030)', fontsize=14)  # label the y axis
plt.savefig('C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Images_and_Figures/reference2/Harmonized_dataset2.png', dpi=300, bbox_inches="tight")
plt.close()
