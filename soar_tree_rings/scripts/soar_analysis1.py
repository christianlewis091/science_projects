...
plt.plot(df['Decimal_date'], df['D14C_ref2t_mean'], color=a1, label='SHB2 (BHD+CGO, harmonized)')
plt.plot(df['Decimal_date'], df['D14C_ref3t_mean'], color=a2, label='SHB1 (BHD w CGO in gaps)')
