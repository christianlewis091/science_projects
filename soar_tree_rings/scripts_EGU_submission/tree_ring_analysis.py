...
for i in range(0, len(sites)):
    ...
    plt.savefig(
        f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/tree_ring_analysis/unfiltered_plots/{sites[i]}.png', dpi=300, bbox_inches="tight")
    plt.close()
...
df.to_excel('C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Data_Files/SOARTreeRingData_CBL_flags_aug_1_2024.xlsx')
...
df_cleaned.to_excel('C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Data_Files/SOARTreeRingData_CBL_cleaned_aug_1_2024.xlsx')
...
for i in range(0, len(sites)):
    ...
    # changing output location for final checks
    plt.savefig(
        f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_EGU_submission/Images_and_Figures/tree_ring_analysis/cleaned_plots/{sites[i]}.png', dpi=300, bbox_inches="tight")
    plt.close()
...
bsp.to_excel('C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Data_Files/bsp.xlsx')
...
plt.savefig(
    ...
    dpi=300, bbox_inches="tight")
plt.savefig(
    f'C:/Users\clewis\IdeaProjects\GNS\soar_tree_rings\output_EGU_submission\Images_and_Figures/tree_ring_analysis\cleaned_plots/Bahia_sidebar.png',
    dpi=300, bbox_inches="tight")
plt.close()
