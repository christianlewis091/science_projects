...
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/SIOLLNLvRRL.png',
...
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/SIOLLNLvRRL_FM.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/ANSTOvRRL.png',
            dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('FM', fontsize=14)  # label the y axis
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/ANSTOvRRL_FM.png',
            dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('\u0394$^1$$^4$C (\u2030)', fontsize=14)  # label the y axis
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/MagallanesvRRL.png',
            dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('FM', fontsize=14)  # label the y axis
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/MagallanesvRRL_FM.png',
            dpi=300, bbox_inches="tight")
plt.close()
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('\u0394$^1$$^4$CO$_2$ (\u2030)', fontsize=14)  # label the y axis
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_figure1.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('\u0394$^1$$^4$CO$_2$ (\u2030)', fontsize=14)  # label the y axis
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_figure2.png',
            dpi=300, bbox_inches="tight")
# plt.show()
plt.close()
# </editor-fold>
...
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_figureS1.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
plt.xlim([1988, 1991])
# plt.legend()
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_Figuretest2.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
plt.ylim([min(bhd_2012_2016_mean_smooth), max(bhd_2012_2016_mean_smooth)])
# plt.legend()
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_figure3b_D14C.png',
            dpi=300, bbox_inches="tight")
# plt.show()
plt.close()
# </editor-fold>
...
plt.xlabel('Date', fontsize=14)
plt.ylabel('FM', fontsize=14)  # label the y axis
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_figure1_FM.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
plt.xlim([1988, 1991])
# plt.legend()
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_Figuretest2_FM.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
plt.ylim([min(bhd_2012_2016_mean_smooth), max(bhd_2012_2016_mean_smooth)])
# plt.legend()
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/DEV_FirstDraft_figure3b_FM.png',
            dpi=300, bbox_inches="tight")
# plt.show()
plt.close()
# </editor-fold>
...
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/FlaskvNaOH.png',
            dpi=300, bbox_inches="tight")
plt.close()
# </editor-fold>
...
df = pd.read_excel(r'C:\Users\clewis\IdeaProjects\GNS\01_science_projects\01_interlab_comparison\03_outputs\Results_table_for_pub.xlsx')  # import data

D14C = df.loc[(df['Parameter Used'] == 'D14C')]
sns.barplot(x=D14C['Time Period'], y=D14C['Result'],  palette="Blues_d")
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/Final_Results_D14C.png',
            dpi=300, bbox_inches="tight")
plt.close()

FM = df.loc[(df['Parameter Used'] == 'FM')]
sns.barplot(x=FM['Time Period'], y=FM['Result'],  palette="Blues_d")
plt.savefig('C:/Users/clewis/IdeaProjects/GNS/01_science_projects/01_interlab_comparison/03_outputs/plots/2022_Intercomparison_Paper/Final_Results_FM.png',
            dpi=300, bbox_inches="tight")
plt.close()