...
#
# df.to_excel(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/from_assign_is_land/points_island_allyears.xlsx')

"""
Now find the avearge % land for each timestep
"""
# READ IN DATA CREATED ABOVE
points = pd.read_excel(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/from_assign_is_land/points_island_allyears.xlsx')
...
results_now.to_excel(f'C:/Users/clewis/IdeaProjects/GNS/soar_tree_rings/output_OPEN_ACCESS/from_assign_is_land/landfracresults.xlsx')
